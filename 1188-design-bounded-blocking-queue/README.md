<h2><a href="https://leetcode.com/problems/design-bounded-blocking-queue">1188. Design Bounded Blocking Queue</a></h2><h3>Medium</h3><hr><p>Implement a thread-safe bounded blocking queue that has the following methods:</p>
